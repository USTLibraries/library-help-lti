...
allow-origin = "/^https?:\/\/(?:(?:[a-z0-9\-]+\.)*yourschooldomain\.edu|yourcanvassubdomain\.(?:[a-z0-9\-]+\.)*instructure\.com)$/i"
...
; RECOMMENDED: "/^https?:\/\/(?:(?:[a-z0-9\-]+\.)*yourschooldomain\.edu|yourcanvassubdomain\.(?:[a-z0-9\-]+\.)*instructure\.com)$/i"
; DEFAULT:     ""


bad-origin-allow-ip = "/^10\.9\.104\.5/"
...
allow-debug-host = "/^https:\/\/yourtestserver\.yourdomain\.edu$/i"
; FORMAT:      Regular Expression (eg "/^https:\/\/yourtestserver\.yourdomain\.edu$/i")
...
api-restrict-access-allow-key[gmpyj] = ""
; FORMAT:      string
...
api_domain = "yourinstitution.instructure.com"
; FORMAT:      string
...
apiDomain = "https://api-na.hosted.exlibrisgroup.com"
; FORMAT:      url
...
; 			   custom format: "https://yourschool.alma.exlibrisgroup.com/leganto/public/YOURCODE/citation/{{citation_id}}?auth=SAML";
...
link[] = "[[URL:http://libguides.yourinstitution.edu]],[[TEXT:Research Help]]"
