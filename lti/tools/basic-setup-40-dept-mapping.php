...
<p>The mapping sheet should be saved as a CSV and uploaded to: /lti/custom/data/dept-subj-mapping.csv</p>

<h3>Current CSV File</h3>

<?php

$homepage = file_get_contents('../custom/data/dept-subj-mapping.csv');
?>
